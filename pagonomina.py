...
class Empleado:
    ...
    def mostrarEmpleado(self):
        print(" Nombre= {:20} Sueldo:$ {}\n Direccion: {:17} Cedula {}\n Telefono: {:18} Fecha de Ingreso:{}\n".format(self.nombre,self.sueldo, self.dirección, self.cedula, self.telefono, self.fecha_ingreso))
...
class Obrero(Empleado):
    def __init__(self,nomb="",suel=0,direc="",ced="",telefono="",fecha_ingr=0,sindicato=False,contratocol=False):
        super().__init__(nomb,suel,direc,ced,telefono,fecha_ingr)
...
class Empresa:
    ...
    def mostrarEmpresa(self):
        print(" Id:{}\n Nombre:{}\n Ruc:{:23}  Direccion: {}\n Telefono: {:18} Razon Social: {}".format(self.__id, self.nombre, self.ruc, self.direccion, self.telefono, self.razonSocial))
...
class SobreTiempo:
    ...
    def mostrarSobreTiempo(self):
        print(" Id:{}\n Horas recargo{}\n Horas extras:{}\n Fecha:{}\n estado: {}".format(self.__id,self.Horarecargo,self.Horaextra,self.fecha,self.estado))
...
class Prestamo:
    ...
    def mostrarPrestamo(self):
        print(" Id:{}\n Fecha:{}\n Valor de prestamo: $ {}\n Numero de pagos:{}\n Cuotas de:$ {}\n Saldo:{}\n Estado:{}\n".format(self.__id,self.fecha,self.valorprest,self.numpagos,self.cuotas, self.saldo, self.estado))
...
class Nomina:
    contadorId=0
    def __init__(self,nombEmp="",empleado='',fecha="",sobretiempo='',comision=0,anti=0,iess=0,prestamo='', ded=''):
        ...
        self.totalSobretiempo = self.sobretiempo.calcSobretiempo(self.sueldo, self.sobretiempo.Horarecargo, self.sobretiempo.Horaextra)
    ...
    def mostrarNomina(self):
        print(" Id:{}\n fecha:{}\n sueldo:{}\n sobretiempo:{}\n comisionEmpOfic:{}\n antigEmpObrero:{}\n iessEmple:{}\n prestamoEmpl:{}\n totalIngreso:{}\n totalDescuento:{}\n liquidoRecibir:{}\n".format(self.__id,self.fecha,
                                                    self.sueldo, self.totalSobretiempo, self.comisEmplOfic, self.anitgEmpObrero, self.iessEmpleado, self.prestamoEmpleado, self.totalIngreso, self.totDes, self.liquidoRecibir))
